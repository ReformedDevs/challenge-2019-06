...
-a, --addr <address>   : Address to load file at (default is 0)     !!lb
...
-q, --quiet            : Quiet mode, exit after goto command finishes   !!lb
"""

# !!lb Modifications marked with !!lb to suppport Reformed Devs Code Golf 2019.06 submission
#      Obtain current/original at https://github.com/mnaberez/py65
...
class Monitor(cmd.Cmd):
    ...
    def __init__(self, argv=None, stdin=None, stdout=None,
        ...
        if argv is None:
            argv = sys.argv
        quiet, addr, load, rom, goto = self._parse_args(argv)  # !!lb added quiet, addr
    ...
    def _parse_args(self, argv):
        try:
            ...
            longopts = ['help',
                'quiet', 'addr='               # !!lb added quiet, addr=
                'mpu=', 'input=', 'output=', 'load=', 'rom=', 'goto=']
