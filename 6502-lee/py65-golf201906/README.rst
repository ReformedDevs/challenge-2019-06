Py65 Reformed Devs Code Golf 2019.06 Modifications
==================================================

This is a modified, incomplete version of Py65 made to support my 6502
submission for Reformed Devs Code Golf 2019.06 
(`https://github.com/ReformedDevs/challenge-2019-06
<https://github.com/ReformedDevs/challenge-2019-06>`_).

I highly recommend obtaining and using the official, non-modified,
complete version of Py65 as described in the original README.rst (text
below), or from
`https://github.com/mnaberez/py65 <https://github.com/mnaberez/py65>`_.
